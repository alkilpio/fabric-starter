...
dockerImages=(\
    ...
    "nginx" \
    "${FABRIC_STARTER_REPOSITORY}/fabric-starter-rest:${FABRIC_STARTER_VERSION:-snapshot-0.11-1.4.4}" \
    "${FABRIC_STARTER_REPOSITORY}/fabric-tools-extended:${FABRIC_STARTER_VERSION:-snapshot-0.11-1.4.4}"
